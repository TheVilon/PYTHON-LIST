...
if salario <= 280.00:
    ...
    print(f"Você recebeu um aumento de 20%: {aumento1}")

elif salario > 280.00 and salario < 700.00:
    aumento2 = salario * 1.15
    print(f"Você recebeu um aumento de 15%: {aumento2}")

elif salario > 700.00 and salario <= 1500.00:
    aumento3 = salario * 1.10
    print(f"Você recebeu um aumento de 10%: {aumento3}")

else:
    aumento4 = salario * 1.05
    print(f"Você recebeu um aumento de 5%: {aumento4}")